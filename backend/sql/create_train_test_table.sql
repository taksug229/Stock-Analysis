...
INSERT INTO `${DATASET_NAME}.train_data` (date, ticker, revenue, fcf, assets, cagr_yrs, revenue_cagr, fcf_cagr, assets_cagr, intrinsic_val, mrkt_cap, mrkt_intrinsic_ratio, stockprice_last_yr, stockprice_current, stock_cagr, volume_last_yr, stockprice_future_1yr)
SELECT  *
FROM stocks.ml
...
INSERT INTO `${DATASET_NAME}.test_data` (date, ticker, revenue, fcf, assets, cagr_yrs, revenue_cagr, fcf_cagr, assets_cagr, intrinsic_val, mrkt_cap, mrkt_intrinsic_ratio, stockprice_last_yr, stockprice_current, stock_cagr, volume_last_yr, stockprice_future_1yr)
SELECT  *
FROM stocks.ml
